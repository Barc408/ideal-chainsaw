# BARC Builder Group — Profile Setup (Bio + Pinned Posts + Highlights)

The profile is a landing page. Every element should answer "who is this for and what do I do next?"
...
- Logo on a solid brand color (orange or black). No text — it's unreadable at 110 px.
- Alt: builder headshot in brand-colored tee. Faces lift CTR on reels.
...
- Alternate dark jobsite photos / bright finished rooms / orange-branded text cards in a 3-column rhythm so the grid reads "builder + educator" at first glance.
- Avoid selfies in the primary grid — put those in stories.
- Every text-card post uses the same 2 fonts + same orange accent.
